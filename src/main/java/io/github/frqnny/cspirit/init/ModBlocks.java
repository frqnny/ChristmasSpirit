...
public class ModBlocks {
    ...
    public static final Block CANDY_CANE_BLOCK_RED = new CSBlock(FabricBlockSettings.of(Material.STONE, DyeColor.RED).sounds(BlockSoundGroup.NETHERRACK));
    public static final Block CANDY_CANE_BLOCK_GREEN = new CSBlock(FabricBlockSettings.of(Material.STONE, DyeColor.GREEN).sounds(BlockSoundGroup.NETHERRACK));
    public static final Block CANDY_CANE_BLOCK_BLUE = new CSBlock(FabricBlockSettings.of(Material.STONE, DyeColor.BLUE).sounds(BlockSoundGroup.NETHERRACK));
    public static final Block CANDY_CANE_BRICK_RED = new CSBlock(FabricBlockSettings.of(Material.STONE, DyeColor.RED).requiresTool().strength(2.0F, 6.0F).sounds(BlockSoundGroup.NETHER_BRICKS));
    public static final Block CANDY_CANE_BRICK_GREEN = new CSBlock(FabricBlockSettings.of(Material.STONE, DyeColor.GREEN).requiresTool().strength(2.0F, 6.0F).sounds(BlockSoundGroup.NETHER_BRICKS));
    public static final Block CANDY_CANE_BRICK_BLUE = new CSBlock(FabricBlockSettings.of(Material.STONE, DyeColor.BLUE).requiresTool().strength(2.0F, 6.0F).sounds(BlockSoundGroup.NETHER_BRICKS));
    ...
    public static final Block CHRISTMAS_LIGHTS_WHITE = new ChristmasLightsBlock(FabricBlockSettings.of(Material.METAL, DyeColor.WHITE).hardness(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision().luminance((state) -> 10));
    public static final Block CHRISTMAS_LIGHTS_WHITE_FLICKERING = new ChristmasLightsBlock(FabricBlockSettings.of(Material.METAL, DyeColor.WHITE).hardness(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision().luminance((state) -> 10));
    public static final Block CHRISTMAS_LIGHTS_RED = new ChristmasLightsBlock(FabricBlockSettings.of(Material.METAL, DyeColor.RED).hardness(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision().luminance((state) -> 10));
    public static final Block CHRISTMAS_LIGHTS_GREEN = new ChristmasLightsBlock(FabricBlockSettings.of(Material.METAL, DyeColor.GREEN).hardness(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision().luminance((state) -> 10));
    public static final Block CHRISTMAS_LIGHTS_BLUE = new ChristmasLightsBlock(FabricBlockSettings.of(Material.METAL, DyeColor.BLUE).hardness(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision().luminance((state) -> 10));
    public static final Block ORNAMENT_RED = new OrnamentBlock(FabricBlockSettings.of(Material.METAL, DyeColor.RED).strength(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision());
    public static final Block ORNAMENT_GREEN = new OrnamentBlock(FabricBlockSettings.of(Material.METAL, DyeColor.GREEN).strength(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision());
    public static final Block ORNAMENT_BLUE = new OrnamentBlock(FabricBlockSettings.of(Material.METAL, DyeColor.BLUE).strength(0.5F).sounds(BlockSoundGroup.LANTERN).nonOpaque().dynamicBounds().noCollision());
