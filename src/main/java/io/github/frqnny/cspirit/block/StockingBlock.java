...
public class StockingBlock extends CSBlock {
    ...
    public static final VoxelShape SHAPE_E = Block.createCuboidShape(14, 2, 2, 15, 14, 16);
    public static final VoxelShape SHAPE_S = Block.createCuboidShape(2, 2, 15, 14, 14, 16);
    public static final VoxelShape SHAPE_W = Block.createCuboidShape(0, 2, 1, 1, 14, 14);
